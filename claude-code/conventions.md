...
See [`allowlist.md`](allowlist.md). The one rule that always holds: **never allowlist arbitrary code execution**; prefer exact invocations or bundled script paths.
